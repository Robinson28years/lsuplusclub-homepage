                    ...
                    <div class="media">
                        <div class="media-left">
                            <a :href="'/user/'+discussion.user.id">
                                <img :src="discussion.user.avatar" style="height: 64px;width: 64px"
                        ...
                        <template v-for="comment in comments">
                            ...
                            <div class="media">
                                ...
                                <a class="media-left" :href="'/user/'+comment.user.id">
                                    <img :src="comment.user.avatar" style="height: 64px;width: 64px"
                                         class="media-object img-circle">
                                </a>
                                <div class="media-body">
                        ...
                        <div class="media" style="margin-top: 8%" v-if="login">
                            <div class="col-md-1">
                                <a href="#">
                                    <img :src="user.avatar" style="height: 64px;width: 64px"
                                         class="media-object img-circle">
                                </a>
                            </div>
                            <div class="col-md-11">
                        ...
                        <!--@else-->
                        <div v-else="">
                            <input class="form-control btn-warning btn pull-right " type="button"
                                   onclick="window.location.href='/auth/login/'" value="登录并参与评论">
                        </div>
                        <!--@endif-->
